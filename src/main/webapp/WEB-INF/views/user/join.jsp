	...
	<main class="form-signin w-100 m-auto">
		<form method="POST" action="/user/join" onsubmit="return validation()">
			...
			*document.querySelector('#uiId');
			document.querySelector('[id=uiId]');
			
			document.getElementsByName('uiId')[0];
			document.querySelectorAll('[name=uiId]')[0];
			 -->
				<input type="text" class="form-control f-top" id="uiId" name="uiId" placeholder="아이디"> 
				<label for="uiId">아이디</label>
			</div>
			<div class="form-floating">
				<input type="password" class="form-control normal" id="uiPwd" name="uiPwd" placeholder="비밀번호"> 
				<label for="uiPwd">비밀번호</label>
			</div>
			<div class="form-floating">
				<input type="text" class="form-control normal" id="uiName" name="uiName" placeholder="이름"> 
			...
			<div class="form-floating">
				...
				<label for="uiGrade">회원등급</label>
			</div>
			
			<button class="w-40 btn btn-lg btn-primary" type="submit">회원가입</button>
