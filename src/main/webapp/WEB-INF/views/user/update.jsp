	...
	<main class="form-signin w-100 m-auto">
		<form method="POST" action="/user/update" onsubmit="return validation()">
			...
			<div class="form-floating">
				<input type="text" class="form-control f-top" id="uiId" name="uiId" placeholder="아이디" value="${user.uiId}"> 
				<label for="uiId">아이디</label>
			</div>
			<div class="form-floating">
				<input type="text" class="form-control normal" id="uiName" name="uiName" placeholder="이름"  value="${user.uiName}"> 
			...
			<button class="w-40 btn btn-lg btn-primary" type="submit">수정</button>
